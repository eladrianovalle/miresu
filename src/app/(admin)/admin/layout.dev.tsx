...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-primary-dark text-text-primary font-ibm-plex [&_a]:no-underline tracking-normal [&_*]:tracking-normal">
        ...
        <nav className="flex items-center gap-1 max-w-6xl mx-auto px-6 h-12">
          ...
          {[
            ...
            <Link
              key={href}
              href={href}
              className="px-2.5 py-1 text-xs font-space-mono text-text-muted hover:text-text-primary hover:bg-surface-2 rounded transition-colors"
            >
              {label}
            </Link>
          ))}
